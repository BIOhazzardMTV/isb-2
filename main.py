...
with open("GPSCH.txt", mode='r', encoding='UTF-8') as text:
    ...
    print(f"P1 = {P1}")  # 0.2888443663464849
    ...
    print(f"P2 = {P2}")  # 0.42870928611174086
    ...
    v2 = lst3.count(2)
    v3 = lst3.count(3)
    v4 = lst3.count(4) + lst3.count(5)
    P3 = 0
    P3 += ((v1 - 16 * 0.2148) ** 2) / (16 * 0.2148)
    P3 += ((v2 - 16 * 0.3672) ** 2) / (16 * 0.3672)
    P3 += ((v3 - 16 * 0.2305) ** 2) / (16 * 0.2305)
    P3 += ((v4 - 16 * 0.1875) ** 2) / (16 * 0.1875)
    print(f"P3 = {P3}")  # 0.90045395
